...
Listing \ref{lis:dfs-gen} shows a generator version of our solver, \textit{including both heuristics}. When called as in Listing \ref{lis:dfs-gen-call}, it produces the trace as shown in Listing \ref{lis:dfs-gen-trace}. % All transversals are generated. No needless backtracking.
