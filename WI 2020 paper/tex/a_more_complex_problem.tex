%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{A logic puzzle}\label{sec:zebra}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
The following execution trace shows the clues in the order executed, including backtracking, followed by the then-current list of partially instantiated students.
