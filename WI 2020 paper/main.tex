...
\IEEEauthorblockA{Visa, Corp. \\ Foster City\\
USA\\
...
\input{tex/transversals}
\input{tex/logic_variables}
\input{tex/a_more_complex_problem}
\printbibliography 
% \input{tex/test}
% % no \IEEEPARstart
